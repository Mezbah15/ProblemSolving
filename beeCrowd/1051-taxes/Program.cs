...
{
    var tax1 = (salary - 2000) * 0.08;
    Console.WriteLine("R$ " + tax1.ToString("0.00"));
}
else if (salary > 3000 && salary <= 4500)
{
    var tax2 = 1000 * 0.08 + (salary - 3000) * 0.18;
    Console.WriteLine("R$ " + tax2.ToString("0.00"));
}
else if (salary > 4500)
{
    var tax3 = 1000 * 0.08 + 1500 * 0.18 + (salary - 4500) * 0.28;
    Console.WriteLine("R$ "+ tax3.ToString("0.00"));
}